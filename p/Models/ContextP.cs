        ...
        public static void Seed(ContextP context)
        {
            context.whatsnews.AddOrUpdate(
                p => p.WorkTime,
                   ...
                   new whatsnew { WorkTime = new DateTime(2013, 5, 22, 12, 00, 0), Work = "logo area color – blue" },
                   new whatsnew { WorkTime = new DateTime(2013, 5, 22, 11, 00, 0), Work = "add whats new in about" },
